        ...
        <Paper elevation={2} className={classes.paper}>
          ...
          <Box component='div'>
            ...
            <Typography variant='subtitle2' color='textSecondary' className={classes.rule_text}>
              ...
              <ol>
                <li className={classes.rule_text}>本サービスの提供・運営のため</li>
                ...
                <li className={classes.rule_text}>上記の利用目的に付随する目的</li>
              </ol>
            </Typography>
            <Typography variant='h6' color='textPrimary' className={classes.rule_title}>
              第4条（利用目的の変更）
            ...
            <Typography variant='subtitle2' color='textSecondary'>
              <ol>
                ...
                <ol>
                  ...
                  <ol>
                    <li className={classes.rule_text}>利用目的に第三者への提供を含むこと</li>
                    <li className={classes.rule_text}>第三者に提供されるデータの項目</li>
                    <li className={classes.rule_text}>第三者への提供の手段または方法</li>
                    <li className={classes.rule_text}>
                      本人の求めに応じて個人情報の第三者への提供を停止すること
                    </li>
                    <li className={classes.rule_text}>本人の求めを受け付ける方法</li>
                  </ol>
                </ol>
                <li className={classes.rule_text}>
            ...
            <Typography variant='subtitle2' color='textSecondary'>
              <ol>
                ...
                <ol>
                  ...
                  <li className={classes.rule_text}>その他法令に違反することとなる場合</li>
                </ol>
                <li className={classes.rule_text}>
